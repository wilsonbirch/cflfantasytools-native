...
export type GamesQuery = { games: Array<{ id: number, date: string | null, homeScore: number | null, awayScore: number | null, homeTeam: { id: number, abbreviation: string } | null, awayTeam: { id: number, abbreviation: string } | null }> };
...
export type GameQuery = { game: { id: number, date: string | null, homeScore: number | null, awayScore: number | null, homeTeam: { id: number, abbreviation: string } | null, awayTeam: { id: number, abbreviation: string } | null, boxScore: Array<{ points: number, totalYards: number, passingYards: number, rushingYards: number, firstDowns: number, turnovers: number, plays: number, epa: number, team: { id: number, abbreviation: string } }>, playerStats: Array<{ player: string, passAttempts: number, completions: number, passingYards: number, passingTouchdowns: number, interceptions: number, rushAttempts: number, rushingYards: number, rushingTouchdowns: number, targets: number, receptions: number, receivingYards: number, receivingTouchdowns: number, epa: number, team: { id: number, abbreviation: string }, targetsByZone: Array<{ depth: PassDepth, direction: PassDirection, targets: number }> }> } | null };
...
export type DepthChartListsQuery = { depthChartLists: Array<{ id: number, year: number, charts: Array<{ id: number, title: string, week: number, season: string, publishedAt: string, url: string, files: Array<{ id: number, fetchedAt: string, size: number, url: string }> }> }> };
